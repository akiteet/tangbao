...
- **Install the app**: download `tangbao-1.1.6-setup.exe` from the [GitHub Releases](https://github.com/akiteet/tangbao/releases/latest) page and run it.
- **Run from source**:
...
>
> **Package**: `npm run dist` → `dist/tangbao-1.1.6-setup.exe`
