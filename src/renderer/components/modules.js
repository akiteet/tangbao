...
(function () {
  ...
  const BUILTIN_MODULES = [
    ...
    { id: 'tavern', label: '糖馆', icon: '<svg viewBox="0 0 24 24" width="18" height="18"><path d="M4 10h16M6 10v9M18 10v9M3 19h18M5 10l7-6 7 6" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 14h6" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>' },
